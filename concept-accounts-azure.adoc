...
summary: 您应了解BlueXP如何使用Azure凭据和权限、以便管理一个或多个Azure订阅的凭据。例如、您可能希望了解如何向BlueXP添加其他Azure凭据。 
---
= Azure 凭据和权限
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
您应了解BlueXP如何使用Azure凭据和权限、以便管理一个或多个Azure订阅的凭据。例如、您可能希望了解如何向BlueXP添加其他Azure凭据。

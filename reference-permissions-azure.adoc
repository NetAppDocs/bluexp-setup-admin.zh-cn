...
| Microsoft.Network/privateEndpoints/delete" ， Microsoft.Compute/availabilitySets/delete" ， | 使BlueXP能够在部署失败或删除时从属于Cloud Volumes ONTAP 的资源组中删除资源。 

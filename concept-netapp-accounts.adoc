...
summary: BlueXP帐户为您的组织提供多租户功能、使您能够在隔离的工作空间中组织用户和资源。例如、一组用户可以在其他用户不可见的工作空间中部署和管理Cloud Volumes ONTAP 系统。 
---
= 了解有关BlueXP帐户的信息
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
BlueXP account_为您的组织提供多租户功能、使您能够在隔离的_workspace中组织用户和资源。例如、一组用户可以在其他用户不可见的工作空间中部署和管理Cloud Volumes ONTAP 系统。

...
我们更新了适用于Azure的Connector策略、以包括以下权限：
...
* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html["了解Cloud Volumes ONTAP对虚拟机扩展集的支持"^]

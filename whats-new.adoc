...
您现在可以在BlueXP中查看Google Cloud NetApp Volumes 。 link:https://docs.netapp.com/us-en/bluexp-cloud-volumes-service-gcp/index.html["了解有关Google Cloud NetApp Volumes 的更多信息。"]

...
+
向BlueXP添加新的AWS凭据可为BlueXP提供创建和管理适用于ONTAP 的FSX所需的权限。 https://["了解如何为适用于 ONTAP 的 FSX 设置权限"^]
...
image:screenshot_accounts_switch_aws.png["屏幕截图、显示在详细信息和amp；凭据页面中选择切换帐户后在云提供商帐户之间进行选择的情况。"]
...
有关详细信息，请参见 https://["适用于ONTAP 的Amazon FSX的BlueXP文档"^]

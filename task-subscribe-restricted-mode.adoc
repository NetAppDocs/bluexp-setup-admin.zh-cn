...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-aws-accounts.html["管理BlueXP的AWS凭据和订阅"]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-azure-accounts.html["管理BlueXP的Azure凭据和订阅"]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-gcp-accounts.html["管理BlueXP的Google Cloud凭据和订阅"]

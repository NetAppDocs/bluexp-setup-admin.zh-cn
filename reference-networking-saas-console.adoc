...
* link:task-set-up-networking-aws.html#endpoints-contacted-for-day-to-day-operations["Connector在AWS中连接的端点(标准模式)"]
* link:task-set-up-networking-azure.html#endpoints-contacted-for-day-to-day-operations["Connector在Azure中联系的端点(标准模式)"]
* link:task-set-up-networking-google.html#endpoints-contacted-for-day-to-day-operations["Connector在Google Cloud中联系的端点(标准模式)"]

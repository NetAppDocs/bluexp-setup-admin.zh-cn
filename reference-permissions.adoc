...
| 从BlueXP部署Connector | 从BlueXP部署Connector时、您需要使用有权在Azure中部署Connector VM的Azure帐户或服务主体。 | link:task-install-connector-azure-bluexp.html#step-2-create-a-custom-role["设置Azure权限"] 

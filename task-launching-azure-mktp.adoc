...
.. 输入系统名称。
+
image:screenshot_set_up_cloud_manager.gif["屏幕截图显示了设置BlueXP屏幕、您可以通过该屏幕选择NetApp帐户并为系统命名。"]
...
如果Connector位于Azure商业区域、请打开Web浏览器并转到 https://cloudmanager.netapp.com[] 开始将Connector与BlueXP结合使用。

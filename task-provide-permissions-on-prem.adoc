...
.结果
现在、BlueXP拥有代表您在AWS中执行操作所需的权限。现在、您可以转到 https://["BlueXP控制台"^] 开始将Connector与BlueXP结合使用。
...
.结果
现在、BlueXP拥有代表您在Azure中执行操作所需的权限。现在、您可以转到 https://["BlueXP控制台"^] 开始将Connector与BlueXP结合使用。

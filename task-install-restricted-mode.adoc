...
.步骤
. 转至 https://["AWS Marketplace上的BlueXP页面"^]
...
** https://["Azure政府区域的Azure Marketplace页面"^]
...
+
此设置非常重要，因为托管身份允许 Connector 虚拟机在不提供任何凭据的情况下向 Azure Active Directory 标识自己。 https://["详细了解 Azure 资源的托管身份"^]。
